...
public interface Constantes {
    ...
    public static final Image PROYECTIL = new ImageIcon("proyectil.png").getImage();
    ...
    public static final Image CANON = new ImageIcon ("cañon.png").getImage();
    public static final Image IMAN = new ImageIcon ("iman.png").getImage();
